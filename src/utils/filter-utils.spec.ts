...
const binderNodes = `
        ...
        <trans-unit id="binder.navbar.audit-trail" datatype="html">
          ...
          <context-group purpose="location">
            <context context-type="sourcefile">config.ts</context>
            <context context-type="linenumber">13,14</context>
          </context-group>
        </trans-unit>`;
const libNodes = `
        <trans-unit id="lib.ui.confirm-dialog.yes" datatype="html">
          <source>Yes</source>
          <context-group purpose="location">
            <context context-type="sourcefile">node_modules/projects/ui-lib/src/lib/confirm-dialog/confirm-dialog.component.ts</context>
            <context context-type="linenumber">97,98</context>
          </context-group>
        </trans-unit>
        <trans-unit id="lib.ui.duration-unit.years" datatype="html">
          <source>Years</source>
          <context-group purpose="location">
            <context context-type="sourcefile">node_modules/projects/ui-lib/src/lib/utils/duration-helper.ts</context>
...
describe('FileUtils', () => {
    it('should filter XML lib nodes', () => {
        const xpathFilterPattern = '//ns:trans-unit[(starts-with(@id, "lib"))]';
    ...
    it('should filter XML none lib nodes', () => {
        const xpathFilterPattern = '//ns:trans-unit[not(starts-with(@id, "lib"))]';
        const actual = FilterUtils.applyXPathFilter(xmlAllNodes, xpathFilterPattern, namespaces);
